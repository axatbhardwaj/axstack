...
| `push-before-gate` (docs) | rev-2 (T2) | `rev-2 docs` | `no sentence matches /gh stack publication does not apply to automation repairs/`. 9 pass, 1 fail. | 10 pass, 0 fail | `22b84c1` |
